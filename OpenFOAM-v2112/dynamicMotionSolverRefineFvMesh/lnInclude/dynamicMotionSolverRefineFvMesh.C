...
#include "dynamicMotionSolverRefineFvMesh.H"
...
#include "cellSet.H"
#include "HashOps.H"
#include "motionSolver.H" //Added to the Header
#include "mapPolyMesh.H" //Added to the Header

// * * * * * * * * * * * * * * Static Data Members * * * * * * * * * * * * * //

namespace Foam
{
    defineTypeNameAndDebug(dynamicMotionSolverRefineFvMesh, 0);
    addToRunTimeSelectionTable(dynamicFvMesh, dynamicMotionSolverRefineFvMesh, IOobject);
    addToRunTimeSelectionTable(dynamicFvMesh, dynamicMotionSolverRefineFvMesh, doInit);
}

// * * * * * * * * * * * * Protected Member Functions  * * * * * * * * * * * //

void Foam::dynamicMotionSolverRefineFvMesh::calculateProtectedCells
(
...
void Foam::dynamicMotionSolverRefineFvMesh::readDict()
{
...
void Foam::dynamicMotionSolverRefineFvMesh::mapFields(const mapPolyMesh& mpm)
{
...
Foam::dynamicMotionSolverRefineFvMesh::refine
(
...
Foam::autoPtr<Foam::mapPolyMesh>
Foam::dynamicMotionSolverRefineFvMesh::unrefine
(
...
Foam::scalarField
Foam::dynamicMotionSolverRefineFvMesh::maxPointField(const scalarField& pFld) const
{
...
Foam::scalarField
Foam::dynamicMotionSolverRefineFvMesh::maxCellField(const volScalarField& vFld) const
{
...
Foam::scalarField
Foam::dynamicMotionSolverRefineFvMesh::cellToPoint(const scalarField& vFld) const
{
...
Foam::scalarField Foam::dynamicMotionSolverRefineFvMesh::error
(
...
void Foam::dynamicMotionSolverRefineFvMesh::selectRefineCandidates
(
...
Foam::labelList Foam::dynamicMotionSolverRefineFvMesh::selectRefineCells
(
...
Foam::labelList Foam::dynamicMotionSolverRefineFvMesh::selectUnrefinePoints
(
...
void Foam::dynamicMotionSolverRefineFvMesh::extendMarkedCells
(
    bitSet& markedCell
) const
{
...
void Foam::dynamicMotionSolverRefineFvMesh::checkEightAnchorPoints
(
...
Foam::dynamicMotionSolverRefineFvMesh::dynamicMotionSolverRefineFvMesh
(
    const IOobject& io,
    const bool doInit
)
:
    ...
    motionPtr_(motionSolver::New(*this)), //Add a pointer to the motionSolver
    meshCutter_(*this)
{
    if (doInit)
    {
...
bool Foam::dynamicMotionSolverRefineFvMesh::init(const bool doInit)
{
    if (doInit)
    {
...
bool Foam::dynamicMotionSolverRefineFvMesh::update()
{
    fvMesh::movePoints(motionPtr_->newPoints());// Add a function call to the motionSolver
...
bool Foam::dynamicMotionSolverRefineFvMesh::writeObject
(
